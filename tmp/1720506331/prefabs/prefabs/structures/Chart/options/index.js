...
exports.categories = [
    {
        label: 'Sizing',
        expanded: false,
        members: ['outerSpacing', 'width', 'height'],
    },
    {
        label: 'Styling',
        expanded: false,
...
exports.chartOptions = {
    ...
    datasetProperty: component_sdk_1.property('Dataset Label Property', {
        value: '',
        configuration: {
            dependsOn: 'model'
        },
    }),
    labelProperty: component_sdk_1.property('X axis Property', {
        value: '',
        configuration: {
            dependsOn: 'model'
        },
    ...
    datasetTypeProperty: component_sdk_1.property('dataset Type Property', {
        value: '',
        configuration: {
            dependsOn: 'model'
        },
    }),
    axisIDProperty: component_sdk_1.property('Y Axis ID Property', {
        value: '',
        configuration: {
            dependsOn: 'model'
        },
    }),
    axisPositionProperty: component_sdk_1.property('Axis position Property', {
        value: '',
        configuration: {
            dependsOn: 'model'
        },
    }),
    axisStackedProperty: component_sdk_1.property('Axis stacked Property', {
        value: '',
        configuration: {
            dependsOn: 'model'
        },
    }),
    datasetStackProperty: component_sdk_1.property('dataset stack Property', {
        value: '',
        configuration: {
            dependsOn: 'model'
        },
