...
exports.flexboxOptions = exports.categories = void 0;
...
exports.categories = [
    {
        label: 'Alignment',
        expanded: true,
        members: ['alignment', 'valignment', 'gap', 'stretch'],
    },
    {
        label: 'Styling',
        expanded: false,
...
exports.flexboxOptions = {
    ...
    stretch: component_sdk_1.toggle('Stretch (when in flex container)', {
        value: false,
    }),
