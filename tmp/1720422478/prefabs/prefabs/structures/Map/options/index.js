...
exports.mapOptions = {
    ...
    layerLegendColor: component_sdk_1.property('Layer Legend color', {
        value: '',
        configuration: {
            dependsOn: 'model',
        },
    ...
    centerLat: component_sdk_1.variable('Default center Latitude', {
        value: ['52.3867431'],
    }),
    centerLng: component_sdk_1.variable('Default center Longituede', {
        value: ['4.6347241'],
    }),
    defaultZoom: component_sdk_1.variable('Default zoom', {
        value: ['10'],
    }),
    fullscreen: component_sdk_1.toggle('Fullscreen', {
        value: true,
    }),
    legend: component_sdk_1.toggle('Legenda', {
        value: true,
    }),
    ...
    ZoomToUserLocation: component_sdk_1.toggle('Zoom to User location', {
        value: false,
        configuration: {
            condition: {
                type: 'SHOW',
