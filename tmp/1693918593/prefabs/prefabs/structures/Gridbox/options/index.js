...
exports.gridboxOptions = {
    gridType: component_sdk_1.buttongroup('gridType', [
    ...
    autofitMaxWidth: component_sdk_1.size('Number of columns', {
        value: '20rem',
        configuration: {
            as: 'UNIT',
            condition: {
    ...
    gridTemplateRowss: component_sdk_1.variable('Grid template rows', {
        value: ['none'],
        configuration: {
            condition: {
                type: 'SHOW',
