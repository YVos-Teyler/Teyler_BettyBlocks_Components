...
exports.MultiAutocomplete = (config, descendants = []) => {
    ...
    return component_sdk_1.component('Multi Autocomplete', { options, style, ref, label, optionCategories: categories }, descendants);
};
