(() => ({
  ...
  jsx: (() => {
    ...
    const [isActionSuccess, setActionSuccess] = useState('');
    ...
    B.defineFunction('ActionSuccess', () => setActionSuccess('success'));
    ...
    const TextFieldCmp = (
      <FormControl
        classes={{
          root: `${classes.formControl} ${floatLabel && classes.formControlFloatLabel} ${isActionSuccess}`,
        }}
        variant={variant}
        size={size}
        fullWidth={fullWidth}
